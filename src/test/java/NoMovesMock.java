...
/**
 * Appends calls to canPlayCard to the log, but reports no possible moves.
 */
public class NoMovesMock implements SanguineModel {
   ...
   */
  public NoMovesMock(Appendable log) {
    this.log = log;
  }
